  ...
  return (
    <section className="care-container">
      <div className="care-row">
        <div>
          <a target="_blank" href="https://treehouseanimals.org/ways-to-give/">
        ...
        <a target="_blank" href="https://treehouseanimals.org/ways-to-give/">
          <img className="care-img" src="https://treehouseanimals.org/wp-content/uploads/2021/05/TH_CatsAtWork_Logo_600x300_VerticalLeftEarTip_300dpi-e1626464213461-1024x574-1000x560-c-default.jpg" />
        </a>
      </div>
      <div className="care-row">
        <div>
          <a target="_blank" href="https://www.chicagocatrescue.org/donate">
        ...
        <a target="_blank" href="https://www.chicagocatrescue.org/donate">
          <img className="chicago-cat-img" src="https://images.squarespace-cdn.com/content/v1/584df1ef579fb3cb326404fe/1575579870771-CMRK01MQNXWP6VEKP4FO/CCR-Logo.png?format=1500w" />
        </a>
      </div>
      <div className="care-row">
        <div>
          <a target="_blank" href="https://hhforcats.org/support-donate/">
        ...
        <a target="_blank" href="https://hhforcats.org/support-donate/">
          <img className="care-img" src="https://hhforcats.org/wp-content/uploads/2013/06/header4.png" />
        </a>
      </div>
    </section>
  )
