  ...
  return (
    <section className="care-container">
      <div className="care-row">
        <div>
          <a target="_blank" href="https://www.aspca.org/pet-care/cat-care/general-cat-care">
        ...
        <a target="_blank" href="https://www.aspca.org/pet-care/cat-care/general-cat-care">
          <img className="care-img" src="https://images.unsplash.com/photo-1619326230097-1b2102190f89?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80" />
        </a>
      </div>
      <div className="care-row">
        <div>
          <a target="_blank" href="https://www.jacksongalaxy.com/blog/">
        ...
        <a target="_blank" href="https://www.jacksongalaxy.com/blog/">
          <img className="care-img" src="https://www.jacksongalaxy.com/wp-content/uploads/2021/09/fountain-800x450.jpg" />
        </a>
      </div>
      <div className="care-row">
        <div>
          <a target="_blank" href="https://hhforcats.org/cat-resources/">
        ...
        <a target="_blank" href="https://hhforcats.org/cat-resources/">
          <img className="care-img" src="https://images.unsplash.com/photo-1517451330947-7809dead78d5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" />
        </a>
      </div>
    </section>
  )
